...
class RoleResource extends Resource implements HasShieldPermissions
{
    ...
    protected static ?string $navigationLabel = 'Roles'; // Etiqueta
    protected static ?string $modelLabel = 'Rol'; // Singular
    protected static ?string $navigationIcon = 'heroicon-o-lock-closed'; // Ícono
